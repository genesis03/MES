...
# 수주 목적(정상/샘플/개발)과 거래구분(유상/무상) API를 기존 sales보다 먼저 적용합니다.
app.include_router(sales_order_policy.router)
# 뒤 LOT를 스캔해도 선입 LOT부터 지정 출고수량까지 자동 배정하는 API를 우선 적용합니다.
